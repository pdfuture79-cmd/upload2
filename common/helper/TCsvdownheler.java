...
@Component
public class TCsvdownheler  implements ApplicationContextAware ,InitializingBean {
	 ...
	 * @throws Exception
	 */
	private String csvParsing(List<LinkedHashMap<String,?>> result) throws Exception{

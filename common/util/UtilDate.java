...
public class UtilDate
{
    ...
    public static int getCurrentYear(){
    	return Integer.parseInt(getCurrentDate().substring(0,4));
    }
    
    public static int getCurrentMonth(){
    	return Integer.parseInt(getCurrentDate().substring(4,6));
    }
    
    public static int getCurrentDay(){
    	return Integer.parseInt(getCurrentDate().substring(6,8));
    }
    
    public static int getCurrentQq(){
...
//    		Date cToDate = Date.valueOf(cTemp);
     ...
     */
    public static String timestamp2StrOnly(Date date)
    {
    	SimpleDateFormat timeKeyFormat  = new SimpleDateFormat("yyyyMMddHHmmss");
    	return timeKeyFormat.format( date);
    }
}